...
public class BookService {
	...
	public Book find_book_by_id_2(int book_id) {
		SqlSession sqlSession = MyBatisSqlSessionFactoryUsingXML.openSession();
		try {
			BookMapper bookMapper = sqlSession.getMapper(BookMapper.class);
			return bookMapper.find_book_by_id_2(book_id);
		} finally {
			sqlSession.close();
		}
	}
	...
	public List<Book> find_book_list_by_author_id_and_more(int author_id, String title) {
	...
	public List<Book> find_book_list_by_publisher_id_or_title_1(int publisher_id, String title) {
		Map<String,Object> map = new HashMap<String,Object>();
		if (publisher_id > 0) {
			map.put("publisher_id", publisher_id);
		}
	...
	public List<Book> find_book_list_by_publisher_id_or_title_2(int publisher_id, String title) {
		Map<String,Object> map = new HashMap<String,Object>();
		if (publisher_id > 0) {
			map.put("publisher_id", publisher_id);
		}
	...
	public List<Book> find_book_list_by_author_id_list_1(List<Integer> author_id_list) {
		Map<String,Object> map = new HashMap<String,Object>();
	...
	List<Book> find_book_list_by_author_id_list_2(List<Integer> author_id_list) {
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("author_id_list", author_id_list);
		SqlSession sqlSession = MyBatisSqlSessionFactoryUsingXML.openSession();
		try {
	...
	public int update_book_alt(Book book) {
		SqlSession sqlSession = MyBatisSqlSessionFactoryUsingXML.openSession();
		try {
			BookMapper bookMapper = sqlSession.getMapper(BookMapper.class);
